...
local Library = {
    ...
    AccentColor = Color3.fromRGB(60, 90, 160);
...
function Library:CreateWindow(...)
    ...
    function Library:Toggle()
        ...
        if Toggled then
            ...
            task.spawn(function() Library:ToggleBlur(true) end)
            Library:StartMatrix()
        ...
        if not Toggled then
            task.spawn(function() Library:ToggleBlur(false) end)
            Library:StopMatrix()
        end
